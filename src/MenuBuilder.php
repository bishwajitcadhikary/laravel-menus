...
namespace WovoSchool\Menus;

use Countable;
use Illuminate\Contracts\Config\Repository;
use Illuminate\Support\Arr;
use Illuminate\View\Factory as ViewFactory;
use WovoSchool\Menus\Presenters\Metronic\MetronicHorizontalMenuPresenter;
...
class MenuBuilder implements Countable
{
     ...
     * @var string
     */
    protected $presenter = MetronicHorizontalMenuPresenter::class;
     ...
     * @param  string $key
     * @param  string $value
     * @return \WovoSchool\Menus\MenuItem
     */
     ...
     *
     * @return \WovoSchool\Menus\Presenters\PresenterInterface
     */
